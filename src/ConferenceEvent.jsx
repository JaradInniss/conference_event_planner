                ...
                {!showItems
                    ...
                    (
                        <div className="items-information">
                            ...
                            <div className="venue_selection">
                                {venueItems.map((item, index) => (
                                    <div className="venue_main" key={index}>
                                        ...
                                        <div className="venue_details">Capacity: {item.capacity} People</div>
                                        <div className="venue_details">${item.cost}</div>
                            ...
                            <div className="total_cost">Venue Total: ${venueTotalCost}</div>
                        </div>
                        ...
                        <div id="addons" className="venue_container container_main">
                            ...
                            <div className="total_cost">Add-ons Total: ${avTotalCost}</div>
                        </div>
                        ...
                        <div id="meals" className="venue_container container_main">
                            ...
                            <div className="total_cost">Meals Total: ${mealsTotalCost}</div>
                        </div>
                        </div>
                    ) : (
